...
from edu.uiowa.synz.LTLSynthesizer import synthesize_LTL

from edu.uiowa.utils.CmdLine import cmd_parser, parse_sig_options
from edu.uiowa.utils.FileReader import read_traces_1, read_traces_3
...
if __name__ == "__main__":
    ...
    _size, _count, trace_file, _algo_type, _dict_support, result_file, solver_type, logic_type = parse_sig_options(args)
...
#   
    if logic_type == 'ltl':           
        AP_Lit, benign_traces, rejected_traces, unary_operators, binary_operators, _nsize, target_fml, max_trace_length = read_traces_3(trace_file, _dict_support)
        
        tic = timeit.default_timer()        
        synthesize_LTL(_size, _count, AP_Lit, _algo_type, solver_type, result_file, trace_file, benign_traces, rejected_traces, unary_operators, binary_operators, _nsize, target_fml, max_trace_length)
    elif logic_type == 'pltl':
        ...
        print('Logic synthesis not supported!')

           
    toc = timeit.default_timer()
    elasped_time = ('%.2f')%(toc- tic)
