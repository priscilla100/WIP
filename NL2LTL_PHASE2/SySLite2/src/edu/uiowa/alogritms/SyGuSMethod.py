...
from edu.uiowa.utils.Printer import eval_result, eval_result1
import timeit
import logging
...
def run_ltl_bv_sygus_algo(_BV_Def_file, _size, _count, trace_file, benign_traces, rejected_traces, unary_ops =  ['!', 'X', 'G', 'F'], binary_ops = ['U','&', '|', '=>'], max_trace_length = 0, AP_Lit = None): 
    ...
    _bv_def = _syngus.bv_sygus_ltl_def(_bv_def)
...
#    logging.debug('Checking Synthesize LTL Formulae...')

#    eval_result1(result, benign_traces, rejected_traces, _count)
