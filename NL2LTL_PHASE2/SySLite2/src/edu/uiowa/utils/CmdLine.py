...
def supported_arguments(parser):
    ...
    optional.add_argument('-l', '--logic_type', default='pltl', choices=['ltl'])
...
def parse_sig_options(args):    
    ...
    return (args.size, args.number, args.tracesFile, args.algo_type, args.support_dict, args.result_file, args.solver_type, args.logic_type)
